#ifndef GrassLandsGamePlay_H_
#define GrassLandsGamePlay_H_
...
class GrassLandsGamePlay : public GameState
{
public: // <-- HACK
	Player*				mPlayer;
	Player*				mPlayer2;
	...
	*/
	...
	//right now im using these in GrassLandsGamePlay AND player. thats not cool.... 
	//this is why manager should have it, and i should use manager in player and in GrassLandsGamePlay. i can load the textures in GrassLandsGamePlay, sure. but 
...
*/
	...
	KeyboardHandler 	mGrassLandsGamePlayKeyboardHandler;

	bool				mDialogueMode;

public:
                        GrassLandsGamePlay(Game* game, Sound* sound);
                        ~GrassLandsGamePlay();
