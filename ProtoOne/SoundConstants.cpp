...
//S_WAV  - sound effect in wav format
//M_MP3  - music in MP3 format

const std::string SoundConstants::FOLDER_SFX = "media/SFX/";
...
const std::string SoundConstants::M_MP3_MQ_FOREST = "MQ-Forest.mp3";
const std::string SoundConstants::M_MP3_SO_TEMPERATE = "SoTemperate.mp3";
