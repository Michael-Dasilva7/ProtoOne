...
const std::string StoryScriptConstants::INTRO_SEQUENCE_2 = "Hey Ya'll! Welcome to my SNES RPG Engine :)";
const std::string StoryScriptConstants::INTRO_SEQUENCE_3 = "Would you like to view the entire intro or jump right into the gameplay?";
